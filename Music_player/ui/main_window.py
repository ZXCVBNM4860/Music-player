...
import os
import sys
from PyQt6.QtWidgets import QMainWindow, QWidget, QHBoxLayout, QVBoxLayout, QStatusBar, QToolBar, QApplication, QMessageBox
...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.status_bar.showMessage(_VERSION)
    ...
    def _on_preview(self, item_id, item_name, item_type):
        ...
        try:
            if item_type == "song" or item_type == "mv":
                ...
                fetcher = _PreviewFetcher(api, item_id, 128000)
                thread = QThread(self)
