...
class SearchDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        self.playlist_table = self._create_table([
            ...
            i18n.tr("col_name"),
            i18n.tr("col_creator"),
            i18n.tr("col_track_count"),
            i18n.tr("col_play_count")
        ])
    ...
    def _create_table(self, headers):
        ...
        # 样式交由应用级 QSS 主题控制，不再硬编码
        return table
    
    @staticmethod
    def _fmt_duration(duration_ms: int) -> str:
        """将毫秒时长格式化为 mm:ss，0 值返回 --:--"""
        if not duration_ms:
            return "--:--"
    ...
    def _fill_table(self, table, items, item_type):
        ...
        for i, item in enumerate(items):
            if item_type == "song":
                ...
                table.setItem(i, 3, QTableWidgetItem(self._fmt_duration(item.get("duration", 0))))
