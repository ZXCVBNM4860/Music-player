...
class DownloadPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        self.btn_search.setStyleSheet("QPushButton {font-weight: bold;padding: 10px;}")
        ...
        self.btn_ai_chat.setStyleSheet("QPushButton {font-weight: bold;padding: 10px;}")
        ...
        self.btn_start.setStyleSheet("QPushButton {font-weight: bold;font-size: 11pt;padding: 10px;}")
